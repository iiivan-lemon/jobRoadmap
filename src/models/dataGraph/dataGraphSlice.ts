...
export const getDataGraph = createAsyncThunk(
  ...
  async (input: string) => {
    const response = await fetchDataGraph(input).then()
    // const response = { status: 200, data: { in_base: '1', position_data: { job_name: 'frontend developer', technology_number: 13, additional: [{ hard_skill: true, technology_name: 'JavaScript', distance: 1.0, professionalism: 0 }, { technology_name: 'Vue.jsVue.jsVue.js', distance: 0.6666666666666666, professionalism: 2, hard_skill: true }, { hard_skill: true, technology_name: 'Git', distance: 0.6666666666666666, professionalism: 1 }, { technology_name: 'CSS', distance: 0.6555555555555556, professionalism: 0 }, { technology_name: 'TypeScript', distance: 0.55, professionalism: 3 }, { technology_name: 'HTML', distance: 0.4916666666666667, professionalism: 0 }, { technology_name: 'CSS3', distance: 0.45, professionalism: 0 }, { technology_name: 'HTML5', distance: 0.45, professionalism: 0 }, { technology_name: 'React', distance: 0.43333333333333335, professionalism: 0 }, { technology_name: 'React.js', distance: 0.4, professionalism: 0 }, { technology_name: 'ReactJS', distance: 0.3333333333333333, professionalism: 1 }, { technology_name: 'Node.js', distance: 0.3333333333333333, professionalism: 1 }, { hard_skill: true, technology_name: 'AngAngularAngularAngularAngularular', distance: 0.3333333333333333, professionalism: 1 }] } } }
