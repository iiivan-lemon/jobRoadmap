        ...
        <div className={'fullResBlock'}>
          <div className={'resumeInput ' + styles.widjet}>
            <form className='resumeBlock' onSubmit={handleSubmit}>
              ...
              <div style={{ display: 'contents' }}><div style={{ textAlign: 'center' }}><a type="submit" style={{ padding: '0.6rem' }} className={styles.newPageColorBtn + ' ' + styles.newPageBtn}
                                                               >получить сопроводительное письмо</a></div>
