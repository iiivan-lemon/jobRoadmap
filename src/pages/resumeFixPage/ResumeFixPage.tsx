      ...
      <div className={'fullResBlock'}>
        <div className={'resumeInput ' + styles.widjet }>
          <form className='resumeBlock' onSubmit={handleSubmit}>
            ...
            <div style={{ display: 'contents' }}><input className={styles.newPageColorBtn + ' ' + styles.newPageBtn} type="submit" id='inputScan' value="сканировать резюме" disabled={(!(selectedJob && selectedFile))} />
