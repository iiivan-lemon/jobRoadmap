...
const Search = ({ changeData, setGrade }): JSX.Element => {
  ...
  return (
      <React.Fragment>
        ...
        {isModalOpen && <HeaderOptions onClose={
          () => {
