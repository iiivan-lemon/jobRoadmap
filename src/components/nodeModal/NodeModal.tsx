...
const NodeModal = ({ onClose, node, isChecked }): JSX.Element => {
  ...
  {/* /> */}
    ...
    {(loading === loadState.res) &&
        <div className='tips' onWheel={(e) => { e.stopPropagation() }}><Linkify options={{ render: renderLink }}>{tips}</Linkify></div>
    }
